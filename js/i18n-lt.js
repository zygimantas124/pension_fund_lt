...
window.FP_TRANSLATIONS_LT = {
  // Labels
  "label.fund_type": "Fondo Tipas",
  "label.manager": "Fondo Valdytojas",
  ...
  "section.extremes.help":
    "Padeda suprasti, kokių svyravimų galima tikėtis - kokie buvo didžiausi vertės kritimai ir augimai per ketvirtį.",

  "section.participants.title": "Dalyvių skaičius",
  "section.participants.help": "Rodo, kiek dalyvių fondas turi naujausiais duomenimis ir kaip dalyvių skaičius pasikeitė laikotarpiu.",
  ...
  // Footer
  "footerDisclaimer":
    "Šios svetainės turinys nėra laikomas finansiniu ar investiciniu patarimu. Prieš priimdami sprendimus, įvertinkite savo riziką ir, jei reikia, pasitarkite su licencijuotu specialistu."
};